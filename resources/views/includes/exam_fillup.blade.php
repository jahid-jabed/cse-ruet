    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default w3-hover-shadow">
                <div class="panel-heading"><h3>Exam Form Fill Up<a href="{{ route('pdf.viewer', ['filename' => 'Exam Form Fill Up']) }}" target="_blank" class="btn btn-primary w3-right">Download</a></h3></div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('form.fillup', ['id' => Auth::user()->roll]) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        
                        <label for="err" class="col-md-12 control-label w3-red w3-small w3-center" style="font-family: monospace">If you do not want to form fill up for any course/s, add a space in 'Course No' and 'Tittle', and 0.00 in 'Credit' fields of those course/s.</label><br><br><br>
                        ...
                        <div class="form-group">
                            <label for="backlog" class="col-md-4 control-label">Backlog Exam</label>
                            <div class="col-md-6">
                                <label class="radio-inline">
                                    <input type="radio" name="backlog" value="1">Yes
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="backlog" value="0">No
                                </label>
                            </div>
                        </div>
